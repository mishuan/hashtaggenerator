...
DISCORD_TOKEN = "Njc3MzA3NzA3NDMwMTQxOTcz.XkSWMw.-jSFD0YV9M4lnh3U-0MxNm84K8I"
...
@bot.command(name='hashtags', help='Generates hashtags based on parameters passed in.')
